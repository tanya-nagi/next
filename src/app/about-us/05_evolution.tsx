      ...
      >
        {timelineData.map((item, index) => (
          ...
          >
            ...
            <div
              className="whitespace-nowrap overflow-x-scroll flex flex-nowrap transition-transform whitespace-nowrap flex flex-nowra scrollbar-hide" // Hide the scrollbar
              ref={timelineRef}
              style={{ scrollBehavior: 'smooth' }} // Smooth scroll when buttons are clicked
            >
              {timelineData.map((item, index) => (
