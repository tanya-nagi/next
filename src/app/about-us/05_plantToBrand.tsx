export default function PlantToBrand() {
  return (
    <section className="blade-top-padding-lg blade-bottom-padding">
      <div className="w-container xlg:max-w-screen-xl max-w-screen-lg ">
        ...
        Our values are brought to life through our behaviors, guiding us <br/> to make thoughtful decisions and take meaningful actions.
        </p>
      </div>
